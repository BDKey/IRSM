...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Keyboard_pin5_Pin|Keyboard_pin4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Keyboard_pin3_Pin|Keyboard_pin2_Pin|Keyboard_pin1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Stopper_pin_Pin IN2_Pin IN1_Pin Keyboard_pin5_Pin
                           Keyboard_pin4_Pin */
  GPIO_InitStruct.Pin = Stopper_pin_Pin|IN2_Pin|IN1_Pin|Keyboard_pin5_Pin
                          |Keyboard_pin4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = Keyboard_pin3_Pin|Keyboard_pin2_Pin|Keyboard_pin1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
